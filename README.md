...
## 🗓️ Планы развития
Проект продолжает развиваться. В ближайших обновлениях запланировано:
### 🔧 Технические улучшения
* **Гибкое переключение моделей** — возможность выбора между qwen2.5-coder:1.5b (быстро, экономно) и qwen2.5-coder:7b (качественнее, для сложных задач) без пересборки контейнеров
* **Автоматический fallback** — если 7B не помещается в память, система автоматически переключится на 1.5B

### 🎯 Функциональные улучшения
* **Умный выбор модели под задачу** — простые запросы → 1.5B, сложные → 7B
* **Кеширование ответов** — ускорение повторных запросов
* **Экспорт/импорт сессий** — сохранение истории диалогов и контекста
